...
makeRecoNtuple::makeRecoNtuple(int ac, char** av)
{
    ...
    if (year=="2016"){
	PUfilename      = "data/PileupHists/Data_2016BCDGH_Pileup.root";
	PUfilename_up   = "data/PileupHists/Data_2016BCDGH_Pileup_scaledUp.root";
	PUfilename_down = "data/PileupHists/Data_2016BCDGH_Pileup_scaledDown.root";

	// PUfilename      = "data/PileupHists/New/PU_2016_35920_XSecCentral.root";
	// PUfilename_up   = "data/PileupHists/New/PU_2016_35920_XSecUp.root";
	// PUfilename_down = "data/PileupHists/New/PU_2016_35920_XSecDown.root";
    }
    if (year=="2017"){
	PUfilename      = "data/PileupHists/Data_2017BCDEF_Pileup.root";
	PUfilename_up   = "data/PileupHists/Data_2017BCDEF_Pileup_scaledUp.root";
	PUfilename_down = "data/PileupHists/Data_2017BCDEF_Pileup_scaledDown.root";

	// PUfilename      = "data/PileupHists/New/PU_2017_41530_XSecCentral.root";
	// PUfilename_up   = "data/PileupHists/New/PU_2017_41530_XSecUp.root";
	// PUfilename_down = "data/PileupHists/New/PU_2017_41530_XSecDown.root";
    }
    if (year=="2018"){
	PUfilename      = "data/PileupHists/Data_2018ABCD_Pileup.root";
	PUfilename_up   = "data/PileupHists/Data_2018ABCD_Pileup_scaledUp.root";
	PUfilename_down = "data/PileupHists/Data_2018ABCD_Pileup_scaledDown.root";

	// PUfilename      = "data/PileupHists/New/PU_2018_59740_XSecCentral.root";
	// PUfilename_up   = "data/PileupHists/New/PU_2018_59740_XSecUp.root";
	// PUfilename_down = "data/PileupHists/New/PU_2018_59740_XSecDown.root";
    }
    if (eventNum > -1) {
    ...
    if (isMC){
    	if (year=="2016") selector->init_JER("data/jecFiles/JER/Summer16_25nsV1");
    	if (year=="2017") selector->init_JER("data/jecFiles/JER/Fall17_V3");
    	if (year=="2018") selector->init_JER("data/jecFiles/JER/Autumn18_V7b");
    }
	...
	if (year=="2016") calib = BTagCalibration("csvv2", "data/BtagSF/CSVv2_Moriond17_B_H.csv");
	if (year=="2017") calib = BTagCalibration("csvv2", "data/BtagSF/CSVv2_94XSF_V2_B_F.csv");
	if (year=="2018") calib = BTagCalibration("csvv2", "data/BtagSF/CSVv2_94XSF_V2_B_F.csv");
    } else {
	if (year=="2016"){ calib = BTagCalibration("deepcsv", "data/BtagSF/DeepCSV_2016LegacySF_V1.csv");}
	if (year=="2017"){ calib = BTagCalibration("deepcsv", "data/BtagSF/DeepCSV_94XSF_V3_B_F.csv");}
	if (year=="2018"){ calib = BTagCalibration("deepcsv", "data/BtagSF/DeepCSV_102XSF_V1.csv");} //DeepCSV_102XSF_V1.csv
	...
	//		jecvar = new JECvariation("data/jecFiles/Summer16_23Sep2016V4", isMC, "Total");//SubTotalAbsolute");
	cout << "Applying JEC uncertainty variations : " << JECsystLevel << endl;
	if (year=="2016") jecvar = new JECvariation("data/jecFiles/Summer16_07Aug2017_V11", isMC, JECsystLevel);
	if (year=="2017") jecvar = new JECvariation("data/jecFiles/Fall17_17Nov2017_V32", isMC, JECsystLevel);
	if (year=="2018") jecvar = new JECvariation("data/jecFiles/Autumn18_V19", isMC, JECsystLevel);
    }
    ...
    if (year=="2016"){
	muSFa = new MuonSF("data/MuEGammaScaleFactors/mu2016/EfficienciesStudies_2016_legacy_rereco_rootfiles_RunBCDEF_SF_ID.root", "NUM_TightID_DEN_genTracks_eta_pt",
			   "data/MuEGammaScaleFactors/mu2016/EfficienciesStudies_2016_legacy_rereco_rootfiles_RunBCDEF_SF_ISO.root", "NUM_TightRelIso_DEN_TightIDandIPCut_eta_pt",
			   "data/MuEGammaScaleFactors/mu2016/EfficienciesStudies_2016_trigger_EfficienciesAndSF_RunBtoF.root", "IsoMu24_OR_IsoTkMu24_PtEtaBins/abseta_pt_ratio");
	
	muSFb = new MuonSF("data/MuEGammaScaleFactors/mu2016/EfficienciesStudies_2016_legacy_rereco_rootfiles_RunGH_SF_ID.root", "NUM_TightID_DEN_genTracks_eta_pt",
			   "data/MuEGammaScaleFactors/mu2016/EfficienciesStudies_2016_legacy_rereco_rootfiles_RunGH_SF_ISO.root", "NUM_TightRelIso_DEN_TightIDandIPCut_eta_pt",
			   "data/MuEGammaScaleFactors/mu2016/EfficienciesStudies_2016_trigger_EfficienciesAndSF_RunGtoH.root", "IsoMu24_OR_IsoTkMu24_PtEtaBins/abseta_pt_ratio");
	
	eleSF = new ElectronSF("data/MuEGammaScaleFactors/ele2016/2016LegacyReReco_ElectronTight_Fall17V2.root",
			       "data/MuEGammaScaleFactors/ele2016/EGM2D_BtoH_GT20GeV_RecoSF_Legacy2016.root",
			       "data/MuEGammaScaleFactors/ele2016/sf_ele_2016_trig_v5.root");
	
	phoSF = new PhotonSF("data/MuEGammaScaleFactors/pho2016/Fall17V2_2016_Medium_photons.root",
			     "data/MuEGammaScaleFactors/pho2016/ScalingFactors_80X_Summer16.root",
			     2016);

	l1PrefireSF = new PrefireWeights("data/MuEGammaScaleFactors/prefire/L1prefiring_photonpt_2016BtoH.root", "L1prefiring_photonpt_2016BtoH",
					 "data/MuEGammaScaleFactors/prefire/L1prefiring_jetpt_2016BtoH.root", "L1prefiring_jetpt_2016BtoH");


    } else if (year=="2017") {
	
	muSFa = new MuonSF("data/MuEGammaScaleFactors/mu2017/RunBCDEF_SF_ID.root", "NUM_TightID_DEN_genTracks_pt_abseta",
			   "data/MuEGammaScaleFactors/mu2017/RunBCDEF_SF_ISO.root", "NUM_TightRelIso_DEN_TightIDandIPCut_pt_abseta",
			   "data/MuEGammaScaleFactors/mu2017/EfficienciesAndSF_RunBtoF_Nov17Nov2017.root", "IsoMu27_PtEtaBins/abseta_pt_ratio");
	
	eleSF = new ElectronSF("data/MuEGammaScaleFactors/ele2017/2017_ElectronTight.root",
			       "data/MuEGammaScaleFactors/ele2017/egammaEffi.txt_EGM2D_runBCDEF_passingRECO.root",
			       "data/MuEGammaScaleFactors/ele2017/sf_ele_2017_trig_v5.root");

	
	phoSF = new PhotonSF("data/MuEGammaScaleFactors/pho2017/2017_PhotonsMedium.root",
			     "data/MuEGammaScaleFactors/pho2017/PixelSeed_ScaleFactors_2017.root",
			     2017);
	
	
	l1PrefireSF = new PrefireWeights("data/MuEGammaScaleFactors/prefire/L1prefiring_photonpt_2017BtoF.root", "L1prefiring_photonpt_2017BtoF",
					"data/MuEGammaScaleFactors/prefire/L1prefiring_jetpt_2017BtoF.root", "L1prefiring_jetpt_2017BtoF");

    } else if (year=="2018") {

	muSFa = new MuonSF("data/MuEGammaScaleFactors/mu2018/EfficienciesStudies_2018_rootfiles_RunABCD_SF_ID.root",  "NUM_TightID_DEN_TrackerMuons_pt_abseta",
			   "data/MuEGammaScaleFactors/mu2018/EfficienciesStudies_2018_rootfiles_RunABCD_SF_ISO.root", "NUM_TightRelIso_DEN_TightIDandIPCut_pt_abseta",
			   "data/MuEGammaScaleFactors/mu2018/EfficienciesStudies_2018_trigger_EfficienciesAndSF_2018Data_BeforeMuonHLTUpdate.root", "IsoMu24_PtEtaBins/abseta_pt_ratio");
	
	muSFb = new MuonSF("data/MuEGammaScaleFactors/mu2018/EfficienciesStudies_2018_rootfiles_RunABCD_SF_ID.root",  "NUM_TightID_DEN_TrackerMuons_pt_abseta",
			   "data/MuEGammaScaleFactors/mu2018/EfficienciesStudies_2018_rootfiles_RunABCD_SF_ISO.root", "NUM_TightRelIso_DEN_TightIDandIPCut_pt_abseta",
			   "data/MuEGammaScaleFactors/mu2018/EfficienciesStudies_2018_trigger_EfficienciesAndSF_2018Data_AfterMuonHLTUpdate.root", "IsoMu24_PtEtaBins/abseta_pt_ratio");

	eleSF = new ElectronSF("data/MuEGammaScaleFactors/ele2018/2018_ElectronTight.root",
			       "data/MuEGammaScaleFactors/ele2018/egammaEffi.txt_EGM2D_updatedAll.root",
			       "data/MuEGammaScaleFactors/ele2018/sf_ele_2018_trig_v5.root");


	phoSF = new PhotonSF("data/MuEGammaScaleFactors/pho2018/2018_PhotonsMedium.root",
			     "data/MuEGammaScaleFactors/pho2018/HasPix_2018.root",
			     2018);
...
void makeRecoNtuple::loadBtagEff(string sampleName, string year){
    std::string fName = "data/BtagSF/btag_efficiencies_"+year+".root";
...
vector<bool> makeRecoNtuple::passPhoMediumID(int phoInd){
...
vector<bool> makeRecoNtuple::passPhoTightID(int phoInd){
...
void makeRecoNtuple::findPhotonCategory(int phoInd, EventTree* tree, bool* genuine, bool *misIDele, bool *hadronicphoton, bool *hadronicfake, bool *puPhoton, bool verbose){ // to use official phoGenMatch
...
//our own pho Gen Match code
 ...
 int makeRecoNtuple::findPhotonGenMatch(int phoInd, EventTree* tree){
...
// int makeRecoNtuple::minDrIndex(double myEta, double myPhi, std::vector<int> Inds, std::vector<float> *etas, std::vector<float> *phis){
// 	double mindr = 999.0;
// 	double dr;
// 	int bestInd = -1;
...
// double makeRecoNtuple::minDr(double myEta, double myPhi, std::vector<int> Inds, std::vector<float> *etas, std::vector<float> *phis){
